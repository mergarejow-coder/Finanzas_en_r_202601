...
p3 <- p3 + scale_x_continuous("Precio del activo") + scale_y_continuous("Payoff") +
  ...
  geom_vline(xintercept = 0, colour = "black") +
  theme(panel.background = element_rect(fill = "white", colour = "grey50")) +
  ggtitle("Posición larga en un activo") + geom_point(aes(x=40, y=0), colour="blue", shape="|", size=10)
p3
...
p5 <- p5 + scale_x_continuous("Precio del activo") + scale_y_continuous("Payoff") +
  geom_hline(yintercept = 0, colour = "black") +
  geom_vline(xintercept = 0, colour = "black") +
  theme(panel.background = element_rect(fill = "white", colour = "grey50")) +ggtitle("Cobertura 1")
p5
#========================================================
